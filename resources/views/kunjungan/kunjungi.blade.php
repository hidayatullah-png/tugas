            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div id="gps-loader" class="text-center py-4 d-none">
                        ...
                        <p class="text-muted">Mencari akurasi GPS terbaik... mohon tunggu di tempat terbuka (Akurasi Target
                            &le; 50m)</p>
                    </div>
                    ...
                    <div id="hasil-kunjungan" class="d-none">
                        ...
                        <table class="table table-bordered mb-4">
                            <tr>
                                ...
                                <td id="view-nama-toko">-</td>
                            </tr>
                            <tr>
                                <th>Jarak Aktual Kalkulasi</th>
                                <td id="view-jarak" class="fw-bold"></td>
                            </tr>
                            <tr>
                                <th>Batas Toleransi Efektif</th>
                                <td id="view-threshold"></td>
                            </tr>
                        </table>
                        ...
                        <div class="row text-muted small text-center">
                            <div class="col-6 border-end">
                                ...
                                Lat: <span id="toko-lat"></span> | Lng: <span id="toko-lng"></span> (<span
                                    id="toko-acc"></span>m)
                            </div>
                            <div class="col-6">
                                <strong>Koordinat Real-time Sales:</strong><br>
                                Lat: <span id="sales-lat"></span> | Lng: <span id="sales-lng"></span> (<span
                                    id="sales-acc"></span>m)
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        async function startGeolocationProcess(barcodeToko) {
            try {
                ...
                // Kirim paket koordinat ke backend via Axios
                axios.post('/api/kunjungan/verifikasi', {
                    barcode: barcodeToko,
                    latitude_sales: salesPos.coords.latitude,   // Ubah key ini
                    longitude_sales: salesPos.coords.longitude, // Ubah key ini
                    accuracy_sales: salesPos.coords.accuracy    // Ubah key ini
                })
                    .then(res => {
